...
SRC_FILES  =main.cpp Materiel.cpp Connectique.cpp Ecran.cpp Inventaire.cpp PetitMateriel.cpp PosteTravail.cpp MaterielReseau.cpp MaterielSpecifique.cpp Salle.cpp SalleInformatique.cpp SalleTechnique.cpp SalleCours.cpp
#
